...
하나는 개념의 역사다. 컴퓨터는 수많은 사람들이 쌓아올린 개념에서 태어났다. 사람들은 20세기 초 추론을 형식화하여 모든 걸 계산해낼 수 있는 완전한 체계의 꿈을 꾸었지만 이내 좌절을 겪었다. 그 자리에서 컴퓨터가 만들어졌다. 이후에도 컴퓨터가 이런 모습으로 우리 눈 앞에 도달하고 사용할 수 있기까지 여러 발전들이 있었다. 튜링 기계뿐 아니라 회로 이론과 폰 노이만 아키텍처, GUI와 같은 이후의 이야기들까지가 이 흐름에 속한다.
...
이후 불은 고향에서 학교를 운영하면서 동료 수학자들과 교류하던 중 이 영감을 더 발전시킨다. 그는 "어떤 강아지는 검다"와 같은 문장에 등장하는 "강아지"이나 "검은 것들"와 같이 종류를 나타내는 단어가 논리에서 중요하다는 걸 깨달았다.
