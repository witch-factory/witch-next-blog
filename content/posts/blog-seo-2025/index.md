---
title: 사이트맵 개선과 구조화된 데이터 작성으로 블로그 검색 엔진 최적화하기
date: "2025-05-25T00:00:00Z"
description: "블로그의 검색 유입이 줄어들기 시작했다. 사이트맵을 개선하고 구조화된 데이터를 넣어서 극복해 보자."
tags: ["blog"]
---
...
블로그의 제목, 설명, 키워드 삽입, og 이미지와 같은 기본적인 부분들은 이미 설정되어 있다. 따라서 그런 아주 기본적인 부분들은 제외하고 개선을 시도한 부분들에 대해서만 기록해 보겠다. 관련된 좋은 문서도 많고 Next.js에서도 관련 문서가 잘 정리되어 있어 참고하였다.
