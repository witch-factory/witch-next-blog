...
![tagged pointer 대략적인 구조](./tagged-pointer-in-use.png)
...
지금까지 discriminated union이라는 가장 원시적인 기법에서 시작해서 tagged pointer, NaN boxing 테크닉까지 알아보았다. discriminated union은 SpiderMonkey의 전신인 Mocha가 잠시 사용했을 뿐인 기법이지만 tagged pointer와 NaN boxing은 현재도 사용되고 있는 기법이다.
