...
export const koResumeContent: ResumeContent = {
  ...
  summary: '추상화 계층을 넘나들며 문제를 해결하는 프론트엔드 개발자입니다. 플러그인을 직접 제작하거나 모듈의 원리를 파악해 근본적인 해결을 하고, UI 라이브러리나 스크립트를 활용해 빠르게 필요한 기능을 구현하거나 자동화합니다. 기술적 선택과 학습 과정에 관해 약 200편의 글을 작성해 왔으며 이를 실무에 적용하기 위해 노력해 왔습니다. 공통 유틸리티나 자동화 도구를 주도적으로 개발하여 팀의 생산성을 높이는 데 기여한 경험도 있습니다. 근본적인 CS와 맥락의 이해부터 AI를 활용한 빠른 구현까지 폭넓은 지식을 통해 문제를 해결하는 개발자를 지향합니다.',
  career: [
    {
      title: 'Tmax FinAI',
