    ...
    <div className={styles.container}>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              보험 가입 프로세스 단계별 페이지와 단계별로 변하는 UI, 에러 처리
              구현
            </li>
            <li>
              보험 페이지 전반에서 사용되는 탭, 라디오버튼, 프로그레스 바, 칩
              등의 공통 컴포넌트 구현
            </li>
            <li>
              클라이언트 요구사항 충족을 위해 HTML 시간 입력 필드의 동작을
              분석하여 time picker 구현
            </li>
          </ul>
        </section>
      ...
      <section>
        ...
        <section>
          ...
          <ul>
            <li>기술:&nbsp;React, TypeScript, Zustand, Tailwind CSS</li>
            <li>
