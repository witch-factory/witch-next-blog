...
function ResumeKOR() {
  return (
    <div className={styles.container}>
      ...
      <hr />
      <p>
      프론트엔드 개발자입니다. 기계공학을 전공하던 중 자신의 일을 사랑한다고 단 1초도 망설임없이 말할 수 있는 열정적인 사람들을 만났고, 그들에게 마음이 끌려 개발자가 되었습니다. 그런 사람들과 함께 개발을 통해 문제를 해결하고 원리를 탐구하고, 알아낸 사실들을 기록하고 알리는 것을 즐겨 왔으며 앞으로도 그렇게 살고자 합니다.
      </p>
      <section>
        <h2>정보</h2>
        <ul>
